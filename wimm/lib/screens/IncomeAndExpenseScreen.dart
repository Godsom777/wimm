...
class _IncomeScreenState extends State<IncomeScreen>
  ...
  String _sortCriteria = 'amount'; // Default sorting criteria
  ...
  void _showAddIncomeForm(BuildContext context) {
    showModalBottomSheet(
      ...
      anchorPoint: Offset(100, MediaQuery.of(context).size.height / 3),
      context: context,
        ...
        return Padding(
          ...
          child: Padding(
              ...
              child: Column(
                ...
                children: [
                  textField(themeProvider, 'Title'),
                  textField(themeProvider, 'Amount'),
                  textField(themeProvider, 'Date'),
                  textField(themeProvider, 'categories'),
                  SizedBox(height: 20),
                  ElevatedButton(
            ...
            blur: 3,
            frostColor: themeProvider.currentTheme!.scaffoldBackgroundColor,
  ...
  Padding textField(ThemeProvider themeProvider, String text) {
    return Padding(
      ...
      child: TextField(
        decoration: InputDecoration(
          ...
          border: OutlineInputBorder(
            ...
            borderSide:
                BorderSide(color: themeProvider.currentTheme!.primaryColor),
          ),
  ...
  Widget build(BuildContext context) {
    final themeProvider = Provider.of<ThemeProvider>(context);
      final double totalValue = 1800; // Define and initialize totalValue
          ...
          child: Column(
            ...
            child: AnimatedPieChart(
              ...
              colorsList: [
                ...
                Colors.green,
                Colors.orange,
                // Add more colors if you have more sections
              ],
               pieData: [
                  MdPieChart(value:  10, name: 'Salary'),
                  MdPieChart(value:  60, name: 'Freelance'),
                  MdPieChart(value: 30, name: 'Investment'),
                  // Add more data here
                ],
            ),
          ),
